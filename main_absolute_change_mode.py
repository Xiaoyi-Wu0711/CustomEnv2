...
def main():
    ...
    train_episode = 300+1
    simulation_day_num = 40 # the simulation days in one iteration 
    ...
    if resume:
        resume_path = "PPO_Mon Sep 25 13:25:37 2023"
    ...
    if reward_shifting:
         print(" shift reward based on average historic performance ")
    if absolute_change_mode:
        print(" The output action is absolute value of toll profiles ")
    print(" env: ", env_name)
    print(" learning_rate ", learning_rate)
    print(" simulation_day_num ",simulation_day_num)
    ...
    if train: 
        ...
        env = gym.make(env_name,
                ...
                train=True, save_dir = save_dir, space_shape=(5, int(12*60/5)),
                One_dim = one_dim, 
        ...
        if resume == True: 
            ...
            model = PPO("MlpPolicy", env, learning_rate=learning_rate, n_steps=150, verbose=1, batch_size=30, 
                        target_kl=0.05, n_epochs=40, gae_lambda=0.97,  ent_coef = entropy_coef, clip_range=0.2, gamma=0.99, 
